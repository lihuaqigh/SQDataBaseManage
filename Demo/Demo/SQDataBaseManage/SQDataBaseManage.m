...
@interface HomeCoupon (Database)

@end

@implementation HomeCoupon (Database)
...
+ (void)saveHistoryCouponToDB:(HomeCoupon *)coupon callBack:(void(^)(BOOL result))callBack {
    ...
    HomeCoupon *oldCoupon = [SQDataBaseManage objectSingle:[HomeCoupon class] where:where orderBy:nil];
